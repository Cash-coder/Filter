...
def apply_category(ebay_category):
    ...
    if ebay_category == 'Movilesytelefonia':
...
with open('scrapper_output.json',encoding='utf8') as json_file:
    ...
    for item in scrapper_data[:15]:        #print(item)
        print(type(item))
...
###################### THIS GOES IN SCRAPPER#################
        ...
        'prod_state':prod_state,'prod_db_category':prod_db_category,
    ...
    with open('filtered3.json','w') as new_file: #,encoding='utf8')
